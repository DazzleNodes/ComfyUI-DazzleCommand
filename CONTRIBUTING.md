# Contributing to ComfyUI-DazzleCommand

Thank you for considering contributing to Dazzle Command!
...
ln -s /path/to/ComfyUI-DazzleCommand ComfyUI-DazzleCommand
```
...
│   └── node.py          # DazzleCommand node class (Python backend)
├── web/
...
1. Check [existing issues](https://github.com/DazzleNodes/ComfyUI-DazzleCommand/issues) first
